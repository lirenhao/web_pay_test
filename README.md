...
- 订单信息
  - 点击“添加”按钮：成功添加商品信息
  - 编辑商品名称文本框：验证规则任何字符串
  - 编辑商品单价文本框：验证规则0-9的阿拉伯数字，长度为6
  - 编辑商品数量文本框：验证规则0-9的阿拉伯数字
  - 删除按钮：删除商品信息
  - 提交订单：空订单，不能提交成功
  - 提交订单：一条商品信息存在，另外一条商品信息完全为空，不能提交成功
  - 点击“提交”按钮：成功提交商品信息

- 点击“订单待支付”按钮：页面跳转到未支付完成的商品订单页面
...
- 选择支付结果下拉菜单-选择成功，点击“确定”按钮，
  - 结果：订单支付完成，页面跳转进"创建订单页面"，收到支付完成的通知
...
- 点击“取消支付”按钮
  - 情况1
      ...
      - 结果：页面跳转到“创建订单”页面
  - 情况2
      - 场景：商户和用户操作同一订单，商户先进入支付页面，用户在“订单页面”再点击“支付”按钮变为灰色，商户在支付页面“取消支付”的情况
      - 操作：“取消支付”按钮
      - 结果：用户端获得支付授权，从订单页面跳转进入支付页面
